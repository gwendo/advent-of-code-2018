...
class TestFileRead {
    @test fun canReadFile() {
        val rows = readFile(".\\out\\test\\advent-of-code\\testfile.in")
    ...
    @test fun solveTest() {
        assertEquals(3, reduceNumbers(readFile(".\\out\\test\\advent-of-code\\testfile.in")))
    }

    @test fun solveOne() {
        println(reduceNumbers(readFile(".\\out\\test\\advent-of-code\\1.in")))
    }

    @test fun solveStepTwo() {
        println(findDuplicateFrequencies(readFile(".\\out\\test\\advent-of-code\\1.in")))
    }
}